...
import OpenCrawl from './audio/open-crawl.mp3'
...
class OpeningCrawl extends Component {
  render() {
    return (
      <div>
        <div className="opening-crawl-section">
          <article className="starwars">
            <audio autoPlay>
              <source src={OpenCrawl} type="audio/mpeg" />
            </audio>
            ...
            <div className="animation">
              ...
              <section className="titles">
                <div contenteditable="true">
                  <center>Episode IV</center>
                  <center className="episode-title">A New Hope</center>
                  <p>
                    It is a period of civil war. Rebel spaceships, striking from a hidden base, have won their first
                    victory against the evil Galactic {this.props.madLibsEntry.food}.
                  </p>

                  <p>
                    During the battle, Rebel spies managed to {this.props.madLibsEntry.verb} secret plans to the
                    Empire's ultimate weapon, the DEATH <span id="death-star">{this.props.madLibsEntry.object}</span>,
                    an armored space station with enough power to destroy an entire planet.
                  </p>

                  <p>
                    Pursued by the Empire's sinister {this.props.madLibsEntry.animal}, Princess Leia races home aboard
                    her starship, custodian of the stolen plans that can save her {this.props.madLibsEntry.beverage} and
